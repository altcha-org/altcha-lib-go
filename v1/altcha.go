...
// VerifyServerSignatureSafe verifies the server's signature using constant-time comparison
...
// SolveChallengeSafe solves a challenge using constant-time comparison
